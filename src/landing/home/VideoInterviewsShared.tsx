/**
 * Shared thumbnail data + marquee components used by both
...
// ─── Data ─────────────────────────────────────────────────────────────────────
export const COMPANY_THUMBS: ThumbItem[] = [
...
export const DSA_THUMBS: ThumbItem[] = [
...
export const CASE_STUDY_THUMBS: ThumbItem[] = [
...
export const MarqueeRow: React.FC<MarqueeRowProps> = ({ items, reverse = false, duration = 38 }) => {
...
// ─── ThumbCard ────────────────────────────────────────────────────────────────
export const ThumbCard: React.FC<{ item: ThumbItem; subLabel?: string }> = ({ item, subLabel }) => (
